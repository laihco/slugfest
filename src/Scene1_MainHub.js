...
export class Scene1_MainHub {
    constructor(renderer) {
        this.playerScale = 0.25;
        this.playerHeight = 3;
        this.playerStartRotationY = Math.PI / 2;
        this.playerStartPosition = new THREE.Vector3(0, 20, 0);
        this.speed = 4;
        this.keys = {};
        this.velocityY = 0;
        this.gravity = -15;
        ...
        this.floorHeight = 1;
        this.floorY = 0;
        this.cameraOffset = new THREE.Vector3(4, 6, 8);
        this.cameraLerpSpeed = 0.1;
        //Scene Transition Cubes
        this.scene3CubePosition = new THREE.Vector3(-10, 0.1, -8);
        this.cubeSize = 2;
        //Carnival Tents
        this.milkTossTentPosition = new THREE.Vector3(-10, 1, -15);
        this.tentRotationX = Math.PI;
        this.tentScale = 3;
        this.tentRadius = 2.4;
        ...
        this.loadGLBModel("/assets/models/Player.glb", this.player, this.playerScale);
        this.setupControls();
        //Scene Cubes
        ...
        this.loadGLBModel("/assets/models/milkTent.glb", this.milkTossTent, this.tentScale);
    }
    addSkyGradient() {
    ...
    loadGLBModel(path, object, scale) {
    ...
    detectTransitionCollisions() {
        if (Math.abs(this.player.position.x - this.cube3Mesh.position.x) <
            this.cubeSize / 2 &&
